...
\textsc{2sg}	&	\textit{	balayye	}	&	\multirow{2}{*}{\textit{	balai	}}	&	\multirow{2}{*}{\textit{	balā	}}	&				\\
\textsc{3sg}	&	\textit{	balā	}	&				&				&	\textit{	balā	}	\\
\textsc{1pl}	&	\textit{	balamā	}	&	\textit{	balamā	}	&	\textit{	balam̊	}	&	\multirow{2}{*}{\textit{	balam̊	}}	\\
\textsc{2pl}	&	\textit{	balāva	}	&	\textit{	balatā	}	&	\multirow{2}{*}{\textit{	balā	}}	&				\\
