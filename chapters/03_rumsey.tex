...
\markuptitle{Egophoricity, engagement and the centring of subjectivity}{Egophoricity, engagement and the centring of subjectivity}
...
%%TODO table 2: poor quality, make a figure?
\begin{table}
\todo[inline]{tablemissing}
...
\begin{figure}
% \begin{tikzpicture}
% \draw (0,0) node[anchor=north]{Speaker A:\\ Mother Wapi}
%  -- (4,0) node[anchor=north]{$Project Speech situation:$}
%  -- (2,3.464) node[anchor=south]{$Addressee: Son Jesi$}
%  -- cycle;
% \end{tikzpicture}
...
\citeauthor{Evansetal2018} note that, although our understanding of “the full panoply” of those means “remains basic” (\citeyear[112]{Evansetal2018}), one of them that has been widely studied at least in western European languages is “the definiteness/ indefiniteness contrasts expressed in article systems” (117). %TODO reference?
